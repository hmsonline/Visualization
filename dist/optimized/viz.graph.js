...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('graph/Edge.js',["d3/d3", "../common/SVGWidget", "../common/TextBox", "css!./Edge"], factory);
    } else {
...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        define('graph/Graph.js',["d3/d3", "../common/SVGWidget", "./IGraph", "./Vertex", "./GraphData", "./GraphLayouts", "../other/Bag", "css!./Graph"], factory);
    } else {
